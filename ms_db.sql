...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2024 at 10:13 PM
...
--
-- Table structure for table `core_phule`
--

CREATE TABLE `core_phule` (
  `Id` int(11) NOT NULL,
  ...
  `Description_ing` varchar(255) DEFAULT NULL,
  `Peso_lbs` double DEFAULT NULL,
...
--
-- Table structure for table `core_pmetal`
--

CREATE TABLE `core_pmetal` (
  `Id` int(11) NOT NULL,
  `Part_number` varchar(255) DEFAULT NULL,
  `Supplier` varchar(255) DEFAULT NULL,
  `Type` varchar(255) DEFAULT NULL,
...
--
-- Indexes for table `core_phule`
--
ALTER TABLE `core_phule`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `core_pmetal`
--
ALTER TABLE `core_pmetal`
  ADD PRIMARY KEY (`Id`);
...
--
-- AUTO_INCREMENT for table `core_phule`
--
ALTER TABLE `core_phule`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `core_pmetal`
--
ALTER TABLE `core_pmetal`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT;
